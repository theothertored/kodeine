...
var require_evaluation_context = __commonJS({
  "engine/dist.node/evaluation/evaluation-context.js"(exports) {
    ...
    var EvaluationContext24 = class {
      ...
      clone() {
        let newCtx = new EvaluationContext24();
    ...
    exports.EvaluationContext = EvaluationContext24;
    ...
    var KodeValue6 = class extends kodeine_js_1.Evaluable {
      ...
      evaluate(evalCtx2) {
        ...
        if (evalCtx2.iReplacement && this.isI) {
          ...
          return new KodeValue6(evalCtx2.iReplacement, this.source);
        } else {
          let localVariableValue = void 0;
          if (evalCtx2.sideEffects.localVariables.size > 0 && this.text && this.text[0] == "#") {
            let localName = this.text.substring(1);
            localVariableValue = evalCtx2.sideEffects.localVariables.get(localName);
          }
          if (localVariableValue) {
            if (evalCtx2.buildEvaluationTree) {
              evalCtx2.sideEffects.lastEvaluationTreeNode = new kodeine_js_1.LiteralReplacement(localVariableValue, literal);
            }
            return new KodeValue6(localVariableValue, this.source);
          } else {
            if (evalCtx2.buildEvaluationTree) {
...
var require_function_call = __commonJS({
  "engine/dist.node/evaluation/evaluables/function-call.js"(exports) {
    ...
    var kodeine_js_1 = require_kodeine();
    var FunctionCall15 = class extends kodeine_js_1.Evaluable {
    ...
    exports.FunctionCall = FunctionCall15;
  }
});
  ...
  "engine/dist.node/evaluation/implementations/functions/fl-function.js"(exports) {
    ...
    var FlFunction2 = class extends kodeine_js_1.IKodeFunction {
      ...
      call(evalCtx2, call, args) {
        ...
        evalCtx2.sideEffects.localVariables = childEvalCtx.sideEffects.localVariables;
...
// engine/dist.node/evaluation/implementations/functions/lv-function.js
var require_lv_function = __commonJS({
  "engine/dist.node/evaluation/implementations/functions/lv-function.js"(exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    exports.LvFunction = void 0;
    var kodeine_js_1 = require_kodeine();
    var LvFunction2 = class extends kodeine_js_1.IKodeFunction {
      getName() {
        return "lv";
      }
      call(evalCtx2, call, args) {
        if (args.length < 1) {
          ...
          let value = evalCtx2.sideEffects.localVariables.get(args[0].text);
          if (!value) {
            evalCtx2.sideEffects.warnings.push(new kodeine_js_1.EvaluationWarning(call, `Local variable "${args[0].text}" not found.`));
          }
          return new kodeine_js_1.KodeValue(value || "", call.source);
        } else if (args.length === 2) {
          evalCtx2.sideEffects.localVariables.set(args[0].text, args[1]);
          return new kodeine_js_1.KodeValue("", call.source);
        } else {
    ...
    exports.LvFunction = LvFunction2;
  }
});
...
// engine/src/evaluation/implementations/functions/lv-function.ts
var init_lv_function = __esm({
  "engine/src/evaluation/implementations/functions/lv-function.ts"() {
    init_kodeine();
  }
});
...
var require_kodeine = __commonJS({
  "engine/dist.node/kodeine.js"(exports) {
    ...
    __exportStar(require_lv_function(), exports);
...
var import_kodeine35 = __toESM(require_kodeine());
...
var EvaluationTreeDataProvider = class {
  ...
  getChildren(element) {
    ...
    } else if (element instanceof import_kodeine33.FormulaEvaluationTree) {
      return element.parts;
    } else if (element instanceof import_kodeine33.EvaluatedUnaryOperation) {
      return [element.arg];
    } else if (element instanceof import_kodeine33.EvaluatedBinaryOperation) {
      return [element.argA, element.argB];
    } else if (element instanceof import_kodeine33.EvaluatedFunctionCall) {
      return element.args;
    } else if (element instanceof import_kodeine33.EvaluatedExpression) {
  ...
  getTreeItem(element) {
    let treeItem = new vscode2.TreeItem(`${element.result.toOutputString()}`, element instanceof import_kodeine33.Literal ? vscode2.TreeItemCollapsibleState.None : vscode2.TreeItemCollapsibleState.Collapsed);
...
var FormulaDocumentEvaluationManager = class {
  ...
  _evaluate(document, options) {
    ...
    try {
      ...
      this._evalCtx.clockMode = Utils.enforceValue(import_kodeine34.ValidClockModes, config.get("clockMode"));
      this._evalCtx.firstDayOfTheWeek = Utils.enforceValue(import_kodeine34.ValidWeekdays, config.get("firstDayOfTheWeek"), 1);
...
function activate(extCtx) {
  ...
  parsingCtx = import_kodeine35.ParsingContextBuilder.buildDefault();
  parser = new import_kodeine35.KodeineParser(parsingCtx);
  evalCtx = new import_kodeine35.EvaluationContext();

...
var require_base = __commonJS({
  "engine/dist.node/base.js"(exports) {
    ...
    exports.Evaluable = Evaluable2;
    var KodeValue2 = class extends Evaluable2 {
      ...
      static fromToken(token) {
        return new KodeValue2(token.getValue(), new EvaluableSource(token));
      }
    };
    exports.KodeValue = KodeValue2;
...
var require_errors = __commonJS({
  "engine/dist.node/errors.js"(exports) {
    ...
    var KodeParsingError = class extends KodeError {
    ...
    var KodeSyntaxError = class extends KodeParsingError {
      constructor(token, message) {
        super("Syntax error", token, message);
      }
    };
    exports.KodeSyntaxError = KodeSyntaxError;
    var KodeFunctionNotFoundError = class extends KodeParsingError {
      constructor(token) {
    ...
    var UnrecognizedTokenError = class extends KodeParsingError {
      constructor(token) {
    ...
    var EvaluationError = class extends KodeError {
    ...
    var InvalidArgumentCountError = class extends EvaluationError {
    ...
    var RegexEvaluationError = class extends EvaluationError {
      constructor(evaluable, message) {
...
var require_evaluation_context = __commonJS({
  "engine/dist.node/evaluables/evaluation-context.js"(exports) {
    ...
    var EvaluationContext2 = class {
      ...
      clone() {
        let newCtx = new EvaluationContext2();
        newCtx.iReplacement = this.iReplacement;
        newCtx.globals = new Map(this.globals);
        return newCtx;
      }
    };
    exports.EvaluationContext = EvaluationContext2;
    ...
    var UnaryMinusStringModeWarning = class extends EvaluationWarning {
...
var require_formula = __commonJS({
  "engine/dist.node/evaluables/formula.js"(exports) {
    ...
    var base_js_1 = require_base();
    var errors_js_1 = require_errors();
    var Formula2 = class extends base_js_1.Evaluable {
      ...
      evaluate(evalCtx2) {
        if (this.evaluables.length === 0) {
          ...
          try {
            return this.evaluables[0].evaluate(evalCtx2);
          } catch (err) {
          ...
          for (var evaluable of this.evaluables) {
            try {
              output += evaluable.evaluate(evalCtx2).text;
            } catch (err) {
              if (err instanceof errors_js_1.EvaluationError) {
                evalCtx2.sideEffects.errors.push(err);
              } else {
...
var require_formula_tokens = __commonJS({
  "engine/dist.node/kodeine-lexer/formula-tokens.js"(exports) {
    ...
    var PlainTextToken = class extends SimpleToken {
      constructor(text, startIndex) {
    ...
    var EscapedDollarSignToken = class extends SimpleToken {
    ...
    var DollarSignToken = class extends SimpleToken {
      constructor(startIndex) {
        super("$", startIndex);
      }
      getName() {
    ...
    var WhitespaceToken = class extends SimpleToken {
      constructor(text, startIndex) {
        super(text, startIndex);
      }
      getName() {
    ...
    var OpeningParenthesisToken = class extends SimpleToken {
      constructor(startIndex) {
        super("(", startIndex);
      }
      getName() {
    ...
    var ClosingParenthesisToken = class extends SimpleToken {
      constructor(startIndex) {
        super(")", startIndex);
      }
      getName() {
    ...
    var CommaToken = class extends SimpleToken {
      constructor(startIndex) {
        super(",", startIndex);
      }
      getName() {
    ...
    var UnquotedValueToken = class extends SimpleToken {
      constructor(text, startIndex) {
        super(text, startIndex);
      }
      getValue() {
    ...
    var OperatorToken = class extends SimpleToken {
...
var require_kodeine_lexer = __commonJS({
  "engine/dist.node/kodeine-lexer/kodeine-lexer.js"(exports) {
    ...
    exports.KodeineLexer = KodeineLexer;
  }
});
...
var require_binary_operation = __commonJS({
  "engine/dist.node/evaluables/binary-operation.js"(exports) {
    ...
    var base_js_1 = require_base();
    var BinaryOperation2 = class extends base_js_1.Evaluable {
    ...
    exports.BinaryOperation = BinaryOperation2;
  }
});
...
var require_expression = __commonJS({
  "engine/dist.node/evaluables/expression.js"(exports) {
    ...
    var base_js_1 = require_base();
    var Expression2 = class extends base_js_1.Evaluable {
      constructor(evaluable, source) {
        super(source);
        this.evaluable = evaluable;
      }
      evaluate(evalCtx2) {
        return this.evaluable.evaluate(evalCtx2);
      }
    };
...
var require_unary_operation = __commonJS({
  "engine/dist.node/evaluables/unary-operation.js"(exports) {
    ...
    var base_js_1 = require_base();
    var UnaryOperation2 = class extends base_js_1.Evaluable {
    ...
    exports.UnaryOperation = UnaryOperation2;
  }
});
...
var require_operator_occurences = __commonJS({
  "engine/dist.node/kodeine-parser/expressions/operator-occurences.js"(exports) {
    ...
    var UnaryOperatorOccurence = class extends OperatorOccurence {
    ...
    var BinaryOperatorOccurence = class extends OperatorOccurence {
      constructor(operator, token) {
        super(token);
        this.operator = operator;
      }
...
var require_function_call = __commonJS({
  "engine/dist.node/evaluables/function-call.js"(exports) {
    ...
    var base_js_1 = require_base();
    var errors_js_1 = require_errors();
    var FunctionCall2 = class extends base_js_1.Evaluable {
...
var require_parsing_context = __commonJS({
  "engine/dist.node/kodeine-parser/parsing-context.js"(exports) {
    ...
    exports.ParsingContext = ParsingContext2;
    var ParsingContextBuilder2 = class {
      constructor() {
        this._functions = {};
      ...
      static buildDefault() {
        return new ParsingContextBuilder2().addDefaults().build();
      }
    };
    exports.ParsingContextBuilder = ParsingContextBuilder2;
    ...
    var UnclosedDollarSignWarning = class extends ParsingWarning {
      constructor(...tokens) {
    ...
    var UnclosedQuotedValueWarning = class extends ParsingWarning {
      constructor(...tokens) {
...
// extension/src/formula-tree-data-provider.ts
var vscode = __toESM(require("vscode"));
var import_formula = __toESM(require_formula());
var import_base = __toESM(require_base());
var import_function_call = __toESM(require_function_call());
var import_binary_operation = __toESM(require_binary_operation());
var import_unary_operation = __toESM(require_unary_operation());
var import_expression = __toESM(require_expression());
var FormulaTreeDataProvider = class {
  ...
  getChildren(element) {
    var _a;
    if (!element) {
      return (_a = this._formula) == null ? void 0 : _a.evaluables;
    } else if (element instanceof import_formula.Formula) {
      return element.evaluables;
    } else if (element instanceof import_function_call.FunctionCall) {
      return element.args;
    } else if (element instanceof import_binary_operation.BinaryOperation) {
      return [element.argA, element.argB];
    } else if (element instanceof import_unary_operation.UnaryOperation) {
      return [element.arg];
    } else if (element instanceof import_expression.Expression) {
  ...
  getTreeItem(element) {
    if (element instanceof import_formula.Formula) {
      return new vscode.TreeItem(`Formula (${element.evaluables.length} part${element.evaluables.length === 1 ? "" : "s"})`, element.evaluables.length > 0 ? vscode.TreeItemCollapsibleState.Expanded : vscode.TreeItemCollapsibleState.None);
    } else if (element instanceof import_function_call.FunctionCall) {
      return new vscode.TreeItem(`Function call: ${element.func.getName()}()`, element.args.length > 0 ? vscode.TreeItemCollapsibleState.Expanded : vscode.TreeItemCollapsibleState.None);
    } else if (element instanceof import_binary_operation.BinaryOperation) {
    ...
    } else if (element instanceof import_base.KodeValue) {
      return new vscode.TreeItem(`Value: ${element.text}${element.isNumeric ? " [numeric]" : ""}`, vscode.TreeItemCollapsibleState.None);
    } else if (element instanceof import_base.Evaluable) {
      return new vscode.TreeItem(`Evaluable: ${element.constructor.name}`, element instanceof import_base.KodeValue ? vscode.TreeItemCollapsibleState.None : vscode.TreeItemCollapsibleState.Expanded);
    } else {
...
function activate(extCtx) {
  ...
  extCtx.subscriptions.push(vscode3.window.registerTreeDataProvider("formulaEvaluationTree", formulaTreeDataProvider));
  globalTreeDataProvider = new GlobalTreeDataProvider([]);
  extCtx.subscriptions.push(vscode3.window.registerTreeDataProvider("globalList", globalTreeDataProvider));
  ...
  if (((_a = vscode3.window.activeTextEditor) == null ? void 0 : _a.document.languageId) === "kode") {
    evaluateToOutput(vscode3.window.activeTextEditor.document);
  } else {
    outChannel.replace("Activate a text editor with its language set to kode to see live evaluation results.");
  }
  extCtx.subscriptions.push(vscode3.window.onDidChangeActiveTextEditor((ev) => {
    var _a2;
    if (((_a2 = ev == null ? void 0 : ev.document) == null ? void 0 : _a2.languageId) === "kode")
      evaluateToOutput(ev.document);
  }));
  extCtx.subscriptions.push(vscode3.workspace.onDidChangeTextDocument((ev) => {
    var _a2;
    if (((_a2 = ev == null ? void 0 : ev.document) == null ? void 0 : _a2.languageId) === "kode")
      evaluateToOutput(ev.document);
  }));
  extCtx.subscriptions.push(vscode3.workspace.onDidOpenTextDocument((doc) => {
    if (doc.languageId === "kode")
      evaluateToOutput(doc);
  }));
  extCtx.subscriptions.push(vscode3.commands.registerCommand("kodeine.formulaResult", () => {
    outChannel.show(true);
  }));
  extCtx.subscriptions.push(vscode3.commands.registerCommand("kodeine.addGlobal", command_addGlobal), vscode3.commands.registerCommand("kodeine.removeGlobal", command_removeGlobal), vscode3.commands.registerCommand("kodeine.clearGlobals", command_clearGlobals), vscode3.commands.registerCommand("kodeine.openGlobalDocument", command_openGlobalDocument));
}
...
${errorMessages.join("\n")}`);
  ...
  if (parsingCtx.sideEffects.warnings.length > 0) {
    parsingCtx.sideEffects.warnings.forEach((warning) => {
      diags.push({
        ...
        range: new vscode3.Range(document.positionAt(warning.tokens[0].getStartIndex()), document.positionAt(warning.tokens[warning.tokens.length - 1].getEndIndex())),
  ...
  if (parsingCtx.sideEffects.errors.length > 0) {
    parsingCtx.sideEffects.errors.forEach((error) => {
      diags.push({
        ...
        range: new vscode3.Range(document.positionAt(error.token.getStartIndex()), document.positionAt(error.token.getEndIndex())),
  ...
  if (evalCtx.sideEffects.warnings.length > 0) {
    evalCtx.sideEffects.warnings.forEach((warning) => {
      diags.push({
        severity: vscode3.DiagnosticSeverity.Warning,
        range: new vscode3.Range(document.positionAt(warning.evaluable.source.getStartIndex()), document.positionAt(warning.evaluable.source.getEndIndex())),
        message: warning.message,
        code: "",
        source: ""
      });
  ...
  if (evalCtx.sideEffects.errors.length > 0) {
    evalCtx.sideEffects.errors.forEach((error) => {
      diags.push({
        severity: vscode3.DiagnosticSeverity.Error,
        range: new vscode3.Range(document.positionAt(error.evaluable.source.getStartIndex()), document.positionAt(error.evaluable.source.getEndIndex())),
        message: error.message,
        code: "",
        source: ""
      });
  ...
  diagColl.set(vscode3.window.activeTextEditor.document.uri, diags);
  formulaTreeDataProvider.setFormula(lastFormula);
}
function command_addGlobal() {
  vscode3.window.showInputBox({
    ...
    if (globalName) {
      ...
      docToGlobalNameMap.set(vscode3.window.activeTextEditor.document, globalName);
      evalCtx.globals.set(globalName, lastFormula);
      vscode3.window.setStatusBarMessage(`gv(${globalName}) has been added.`, globalChangeNotifTimeout);
      refreshGlobalList();
    }
  });
}
function command_removeGlobal(global) {
  if (global) {
    ...
    vscode3.window.showQuickPick(Array.from(docToGlobalNameMap).map((e) => ({
      label: e[1],
...
function removeGlobal(globalName, document) {
  ...
  vscode3.window.setStatusBarMessage(`gv(${globalName}) has been removed.`, globalChangeNotifTimeout);
  refreshGlobalList();
}
function command_clearGlobals() {
  docToGlobalNameMap.clear();
  evalCtx.globals.clear();
  vscode3.window.setStatusBarMessage(`All globals have been removed.`, globalChangeNotifTimeout);
  refreshGlobalList();
}
function command_openGlobalDocument(document) {
  vscode3.window.showTextDocument(document);
}

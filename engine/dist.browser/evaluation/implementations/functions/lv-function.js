import { IKodeFunction, EvaluationWarning, InvalidArgumentCountError, KodeValue } from "../../../kodeine.js";
...
export class LvFunction extends IKodeFunction {
    ...
    call(evalCtx, call, args) {
        if (args.length < 1) {
            ...
            if (!value) {
                evalCtx.sideEffects.warnings.push(new EvaluationWarning(call, `Local variable "${args[0].text}" not found.`));
            }

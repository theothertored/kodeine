    ...
    constructor() {
        ...
        this.mode('n2w', ['txt text'], function (text) {
            ...
            return text.replace(expr, match => {
                ...
                if (-num > max) {
                    throw new InvalidArgumentError('tc(n2w)', 'text', 1, this.call.args[1], match, `Negative numbers throw an error when their absolute value is over the max value for a signed 32 bit int (${max}).`);
                }

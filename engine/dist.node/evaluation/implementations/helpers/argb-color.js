...
class ArgbColor {
    ...
    shiftHue(amount) {
        ...
        ...(0, utils_js_1.hsv2rgb)((h + amount) % 360, s, v));
    }
    /**
     ...
     */
    setAlpha(newAlpha) {
        return new ArgbColor((0, utils_js_1.clamp)(newAlpha, 0, 255), this.r, this.g, this.b);
    }
    /**
    ...
    setSaturation(newSaturation) {
        const [h, s, v] = (0, utils_js_1.rgb2hsv)(this.r, this.g, this.b);
        return new ArgbColor(this.a, ...(0, utils_js_1.hsv2rgb)(h, (0, utils_js_1.clamp)(newSaturation, 0, 1), v));
    }
    /**
    ...
    addSaturation(amount) {
        const [h, s, v] = (0, utils_js_1.rgb2hsv)(this.r, this.g, this.b);
        return new ArgbColor(this.a, ...(0, utils_js_1.hsv2rgb)(h, (0, utils_js_1.clamp)(s + amount, 0, 1), v));
    }
    /**
    ...
    setLuminance(newLuminance) {
        const [h, s, v] = (0, utils_js_1.rgb2hsv)(this.r, this.g, this.b);
        return new ArgbColor(this.a, ...(0, utils_js_1.hsv2rgb)(h, s, (0, utils_js_1.clamp)(newLuminance, 0, 1)));
    }
    /**
    ...
    addLuminance(amount) {
        const [h, s, v] = (0, utils_js_1.rgb2hsv)(this.r, this.g, this.b);
        return new ArgbColor(this.a, ...(0, utils_js_1.hsv2rgb)(h, s, (0, utils_js_1.clamp)(v + amount, 0, 1)));
    }
    ...
    static fromAHSV(a, h, s, v) {
        return new ArgbColor(a, ...(0, utils_js_1.hsv2rgb)(h, s, v));
    }
    ...
    static lerp(color1, color2, fraction) {
        if (fraction < 0) {
            return new ArgbColor((0, utils_js_1.lerp)(color2.a, color1.a, -fraction), (0, utils_js_1.lerp)(color2.r, color1.r, -fraction), (0, utils_js_1.lerp)(color2.g, color1.g, -fraction), (0, utils_js_1.lerp)(color2.b, color1.b, -fraction));
        }
        else {
            return new ArgbColor((0, utils_js_1.lerp)(color1.a, color2.a, fraction), (0, utils_js_1.lerp)(color1.r, color2.r, fraction), (0, utils_js_1.lerp)(color1.g, color2.g, fraction), (0, utils_js_1.lerp)(color1.b, color2.b, fraction));
        }
    }
}

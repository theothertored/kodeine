                ...
                if (token instanceof UnquotedValueToken) {
                    ...
                    if (nextToken instanceof OpeningParenthesisToken) {
                        ...
                        if (func) {
                            ...
                            exprBuilderStack.push(new FunctionCallBuilder(this._env, new FunctionOccurence(func, token, ...(whitespaceTokens !== null && whitespaceTokens !== void 0 ? whitespaceTokens : []), nextToken)));
                        }
                        else {
